...
gulp.task('inject', ['scripts', 'styles', 'injectAuth', 'inject404', 'injectViews', 'copyVendorImages'], function() {
...
gulp.task('injectViews', [], function() {
    return gulp.src(conf.paths.src + '/views/*.html')
        .pipe(gulp.dest(conf.paths.tmp + '/serve/views'));
});
